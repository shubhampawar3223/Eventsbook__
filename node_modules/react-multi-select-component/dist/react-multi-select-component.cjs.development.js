...
var DefaultRenderer = /*#__PURE__*/goober.css({
  "& input,& span": {
 ...
 */
var ItemContainer = /*#__PURE__*/goober.css({
 ...
 */
var SelectListUl = /*#__PURE__*/goober.css({
  margin: 0,
  paddingLeft: 0,
  li: {
    listStyle: "none",
...
var SelectSearchContainer = /*#__PURE__*/goober.css({
  width: "100%",
...
var SelectPanel = function SelectPanel(props) {
  ...
  var _useState2 = React.useState(focusSearchOnOpen && !disableSearch ? FocusType.SEARCH : FocusType.NONE),
  ...
  })), hasSelectAll && !searchText && React__default.createElement(SelectItem, {
...
var Spinner = /*#__PURE__*/goober.css({
 ...
 */
var PanelContainer = /*#__PURE__*/goober.css({
  position: "absolute",
  zIndex: 1,
  top: "100%",
  width: "100%",
...
var DropdownContainer = /*#__PURE__*/goober.css({
  position: "relative",
  outline: 0,
...
var DropdownHeading = /*#__PURE__*/goober.css({
  position: "relative",
  padding: "0 var(--rmsc-p)",
  display: "flex",
  alignItems: "center",
...
var DropdownHeader = function DropdownHeader(_ref) {
  ...
  return noneSelected ? React__default.createElement("span", {
    className: "gray"
  }, customText || getString("selectSomeItems", overrideStrings)) : React__default.createElement("span", null, customText || (allSelected ? getString("allItemsAreSelected", overrideStrings) : getSelectedText()));
};

var MultiSelectBox = /*#__PURE__*/goober.css({
  "--rmscMain": "#4285f4",
  "--rmscHover": "#f1f3f5",
  "--rmscSelected": "#e2e6ea",
  "--rmscBorder": "#ccc",
